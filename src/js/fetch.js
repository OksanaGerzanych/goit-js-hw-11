...
async function pixabayAPI(inputValue, page, perPage) {
  ...
  const response = await axios.get(`https://pixabay.com/api/?key=32945062-68d6d40c8d925b295193ffb26&q=${inputValue}&image_type=photo&orientation=horizontal&safesearch=true&page=${page}&per_page=${perPage}`);
